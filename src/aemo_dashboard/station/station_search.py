...
class StationSearchEngine:
    """Fuzzy search engine for stations and DUIDs"""
    ...
    def __init__(self, duid_mapping):
        ...
        logger.info(f"Search engine initialized with {len(self.search_index)} searchable items")
    ...
    def fuzzy_search(self, query: str, limit: int = 10, min_score: int = 60) -> List[Dict]:
        """
    ...
    def get_popular_stations(self, limit: int = 10) -> List[Dict]:
        """
        ...
        """
        # Sort by capacity (descending) and return top stations
